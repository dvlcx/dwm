...
static const char *cmdsoundnotify[] = {"sh", "-c", "notify-send -t 800 -u low \"Volume\" -h string:x-dunst-stack-tag:vol -h int:value:$(amixer sget Master | tail -1 | awk '{print $4}' | tr -d '[%]')", NULL};
